...
<section class="sec-padding">
    <div class="container">
        ...
        <h1 class="header-font text-center center-line"  data-animation="slideInUp">Contact <span class="text-orange-2">Us</span></h1>
    ...
    <div class="container margin-top-145 mobile-margin-30">
        <div class="row">
            ...
            <div class="col-md-10">
                <h1 class="header-font text-center center-line" data-animation="zoomReverseIn">Find Us on <span class="text-orange-2">Google Map<span></h1>
                <!-- <div class="title-line-4 align-center"></div> -->
                <div class="address-map margin-top" data-animation="slideInUp">
                    <iframe
    ...
    <div class="container margin-top mobile-margin-30">
        <div class="row">
            ...
            <h1 class="header-font text-center center-line" data-animation="slideInUp">We Are <span class="text-orange-2">Located At</span></h1>
            <!-- <div class="title-line-4 align-center"></div> -->
        </div>
        <div class="row">
