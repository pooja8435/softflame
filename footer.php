...
#whatsapp-icon img {
    width: 60px; /* Adjust the icon's width */
    height: 60px; /* Adjust the icon's height */
    border-radius: 50%; /* Make it a circle */
    transition: box-shadow 0.3s; /* Add a smooth transition effect */
}

#whatsapp-icon img:hover {
    box-shadow: 0 0 20px #25d366; /* Add a glowing effect on hover */
    animation: glowing 1s infinite; /* Apply a continuous glowing animation on hover */
}
...
@keyframes glowing {
    ...
    100% {
        ...
        <a href="https://api.whatsapp.com/send?phone=1234567890" target="_blank" id="whatsapp-icon">
