...
<body>
    ...
    <div class="stickyEnrollWidget">
        <div class="col-sm-6 col-xs-12 text-center text-white purchase-button">
            <a href="#" type="button" data-toggle="modal" data-target="#myModal" class="stickyEnquiryWidget"
                id="enquiry_button"></a>
        </div>
            ...
            <div class="container">
                ...
                <div class="topbar-right-items pull-right">
                    <ul class="toplist toppadding">
                        ...
                        <li><a href="https://www.facebook.com/softflame" target="_blank"><i
                        ...
                        <li class="last"><a href="https://www.linkedin.com/in/softflame/" target="_blank"><i
            ...
            <div class="container">
                <div class="navbar navbar-default yamm">
                    ...
                    <div class="navbar-header">
                        ...
                        <a href="index.php" class="navbar-brand"><img src="images/logo web.png"
                                alt="E-Commerce Development Company in Pune, Delhi,Bangalore" /></a>
                    </div>
                    ...
                    <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
                        <ul class="nav navbar-nav" id="navlist">
                                        ...
                                        <div class="yamm-content">
                                            <div class="row">
                                                <ul class="col-sm-8 col-md-4 list-unstyled mg_top">
                                                    ...
                                                    <li class="mg_top"><a
                                                            href="website-development-company-in-pune.php"><i
                            ...
                            <li class="dropdown"> <a href="hire_resources.php" class="dropdown-toggle">Hire
                                    Resources</a>
