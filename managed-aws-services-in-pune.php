...
<head>
    ...
    <title> Managed AWS Services in Pune | Bangalore | Delhi | SoftFlame Solutions </title>
    <meta charset="utf-8">
    <!-- Meta -->
    <meta name="keywords"
        content="Managed AWS Services in Pune, Bangalore , Delhi, website company in Pune, Bangalore , Delhi, web development company in Pune, Bangalore , Delhi,website design in Pune, Bangalore , Delhi,web design company,web design pune,web development company, website design company, ecommerce website design,ecommerce websites development,SEO services pune,seo company in Pune, Bangalore , Delhi" />
    <meta name="author" content="">
    <meta name="robots" content="" />
    <meta name="description"
        content="Managed AWS Services in Pune, Bangalore , Delhi - Right from SysOps, security management, and backups to disaster recovery we provide end to end AWS Managed Services. We are AWS Managed Services partners." />
...
<![endif]-->
    ...
    <style>
        ...
        .we-offer-area .our-offer-carousel .owl-dots .owl-dot.active span {
            background: #5ebbf5 none repeat scroll 0 0;
            border-color: #5ebbf5;
        }

        .we-offer-area .item {
            background: #ffffff none repeat scroll 0 0;
            border-left: 2px solid #5ebbf5;
...
<section>
    <div class="header-inner two">
        <div class="inner text-center col-md-6 padding-top">
            <h1 data-animation="zoomReverseIn" class="font-family text-white sub-nav-head uppercase">AWS Managed
                Services</h1>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="pagenation_links text-font font-16"><a href="index.php">Home</a><i> / </i><a
                            href="services.php">Services</a><i> / </i>AWS Managed Services</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container margin-top mobile-margin-30">
        <div class="row">
            <div class="col-md-8" data-animation="slideInRight">
                ...
                <ul class="ex2">
                    <li>System Health Checks, Updates and Tune-Ups</li>
                    <li>Managed High Performance Computing</li>
                    <li>Monitoring, Alerting, Patching & Updating</li>
                    <li>Reporting & Performance Analysis</li>
                    <li>Service management for 24*7*365</li>
                </ul>
