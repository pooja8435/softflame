...
<head>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-584S6F7');
    </script>
    <!-- End Google Tag Manager -->

    <title>Softflame Solutions - Website Development Company in Pune | Website Developer in Pune | Bangalore | Delhi
    </title>
    <meta name="description"
        content="Website Development in Pune, Bangalore, Delhi - Softflame Solutions is Website Developer in Pune, Bangalore, Delhi who offers Website Development in Pune, Bangalore, Delhi, Web Design,Website Development company in Pune, Bangalore, Delhi,Android App Development,SEO Company in Pune, Bangalore, Delhi,Social Media Services in Pune, Bangalore, Delhi." />
    <meta name="keywords"
        content="Website Developer in Pune, Bangalore, Delhi, Website Development in Pune, Bangalore, Delhi " />
    <meta name="robots" content="index, follow">
    <meta name="copyright" content="softflame.in">
    <meta name="language" content=“EN”>
    <meta name="google-site-verification" content="RfRoL4qZ68TC5efdA5Rid4WPt1mg3DooD-RAP4vIu1c" />
    ...
    <link rel="stylesheet" href="css/layouts.css" type="text/ss" />
...
.card h2:after {
  background: linear-gradient(to right, #a2cfe9, #007bff);
  right: -5px;
  top: -5px;
}

.card h2:before {
  background: linear-gradient(to right, #007bff, #a2cfe9);
  left: -5px;
  bottom: -5px;
}
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-584S6F7" height="0" width="0"
...
<path fill="#3F51B5" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"></path><path fill="#FFF" d="M34.368,25H31v13h-5V25h-3v-4h3v-2.41c0.002-3.508,1.459-5.59,5.592-5.59H35v4h-2.287C31.104,17,31,17.6,31,18.723V21h4L34.368,25z"></path>
            ...
            <div class="container">
                <div class="topbar-left-items">
                    <ul class="toplist toppadding pull-left paddtop1">
                        ...
                        <li><a href="tel:+919145278333">+91-9021649159</a>, <a
                                href="tel:+918446425690">+91-8446425690</a>, <a
                ...
                <div class="topbar-right-items pull-right">
                    <ul class="toplist toppadding">
                        <li><a href="https://www.facebook.com/Softflame-Solutions-Pvt-Ltd-2173947799583603/"
                                target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href=" https://twitter.com/SoftflameL" target="_blank"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li><a href="https://www.instagram.com/softflame_solutions/" target="_blank"><i
                                    class="fa fa-instagram"></i></a></li>
                        <li class="last"><a href="https://www.linkedin.com/company/26552568/admin/" target="_blank"><i
        ...
        <!-- <div class="master-slider ms-skin-default marg_tpslide" id="masterslider"
            ...
            <div class="ms-slide slide-2" data-delay="9">
                ...
                <h3 class="ms-layer small-line" style="left: 370px;top: 380px;" data-type="text" data-delay="2500"
                    data-ease="easeOutExpo" data-duration="1230" data-effect="left(250)"></h3>
                <h3 class="ms-layer text88" style="left: 350px;top: 385px;" data-type="text" data-delay="3000"
  ...
  <div class="responsive-container-block Container bottomContainer">
    ...
    <div class="allText bottomText">
      ...
      <p class="text-blk subHeadingText" style="font-weight: 700;line-height: 1.2;color: #181d38;">
      SoftFlame Solutions Pvt. Ltd.
      </p>
        ...
        <section class="engineering-details">
            <!-- <div class="auto-container">
                ...
                <div class="sec-title col-md-12 text-center">
                    ...
                    <div class="col-md-offset-1 col-md-10 padding_btm">
                        <p class="init_text"><strong>Softflame Solutions</strong> is founded by experienced technical
                            expert team.<b>Softflame Solutions</b> is agile development methodology following with
                            innovative solutions and services with latest and trending technologies. We want our clients
                            to understand that our passion is about client satisfaction by finding efficient and better
                            solutions that help our client connect to their business strategy. <u><a
                                    href="https://www.softflame.in/website-development-company-in-pune.php"><b>Website
                                        Development, Web Developers in Pune, Bangalore, Delhi</u></b></a>,<strong>
                                tailor made applications, ERPs, CRMs, CMS, LMS, e-commerce solutions,
                                business-to-business applications, business-to-client applications, managed
    ...
    <div class="row">
        ...
        <div class="col-md-6 h-100 w-100" >
            <!-- Add your image here -->
            <img src="img/what-we-do.jpg" alt="Services Image" class="img-responsive" style="padding-top: 20px;">
        </div>
    </div>
</div>
...
<div class="servicess container" style="margin-bottom: 50px;">
  <div class="services-section">
    ...
    <section class="sec-padding our-work">
    <div class="container">
        ...
        <div class="container" style="max-width:1200px">
            <div class="row">
                ...
                <div class="col-md-7 bmargin">
                    <img src="img/why-work.png" alt="Website Development in Pune, Bangalore, Delhi"
                        class="img-responsive" style="margin-top:-16%;"/>
                </div>
                <!--end item-->
